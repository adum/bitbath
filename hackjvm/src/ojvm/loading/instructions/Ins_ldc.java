...
public class Ins_ldc extends Instruction {
  ...
  public Ins_ldc (InstructionInputStream classFile, ConstantPool cp) throws ClassFileInputStreamE, ConstantPoolE {
      super(RuntimeConstants.opc_ldc);
      int index = classFile.readU1();
      ...
      else throw new ConstantPoolE("Bad argument " + ce + " to ldc instruction");
  }
